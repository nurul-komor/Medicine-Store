...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.4.26/sweetalert2.min.js">
...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
        ...
        <div class="body flex-grow-1 px-3 ">
            <div class="col-lg-4 card p-3 mb-5">
                <form action="category-ajax.php" method="post" id="addCategory" target="_blank">
